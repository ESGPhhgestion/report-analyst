...
import os
import yaml
from report_analyst.core.question_loader import QuestionSetLoader, QuestionSet, get_question_loader
    ...
    def test_question_set_shortcuts(self):
        ...
        for qset_id, expected_shortcut in expected_shortcuts.items():
            if qset_id in question_sets:
                ...
                assert qset.shortcut == expected_shortcut, f"Expected {qset_id} to have shortcut '{expected_shortcut}', got '{qset.shortcut}'"
