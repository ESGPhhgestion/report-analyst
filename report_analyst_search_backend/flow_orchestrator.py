...
class FlowOrchestrator:
    ...
    def process_document(self, uploaded_file) -> ProcessingResult:
        ...
        try:
            ...
            elif flow_type in ["basic_backend", "backend_with_features", "enhanced_integration"]:
    ...
    def analyze_document(self, chunks: List[Dict[str, Any]], 
                        questions: List[str]) -> AnalysisResult:
        """
        ...
        try:
            if flow_type == "local":
                ...
                return AnalysisResult(
                    success=False, 
                    error=f"Analysis not supported for flow: {flow_type}"
                )
        except Exception as e:
            logger.error(f"Document analysis failed: {e}")
            return AnalysisResult(success=False, error=str(e))
    
    def complete_backend_analysis(self, uploaded_file, 
                                 question_set: str) -> AnalysisResult:
        """
    ...
    def _analyze_local(self, chunks: List[Dict[str, Any]], 
                      questions: List[str]) -> AnalysisResult:
        """Analyze locally"""
    ...
    def _analyze_local_with_features(self, chunks: List[Dict[str, Any]], 
                                   questions: List[str]) -> AnalysisResult:
    ...
    def _analyze_enhanced(self, chunks: List[Dict[str, Any]], 
                         questions: List[str]) -> AnalysisResult:
