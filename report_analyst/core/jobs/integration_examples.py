...
def create_celery_tasks(celery_app):
    ...
    def analyze_document_task(self, 
                             document_id: str,
                             question_set_id: str,
    ...
    @celery_app.task(bind=True)
    def analyze_document_with_progress_task(self, 
                                          document_id: str,
                                          question_set_id: str,
                                          selected_questions: list,
                                          model_name: str = "gpt-4o-mini",
        ...
        try:
            result = asyncio.run(analyze_document_with_progress(
                document_id=document_id,
                question_set_id=question_set_id,
                selected_questions=selected_questions,
...
class SearchBackendAnalysisIntegration:
    ...
    def create_celery_task(self, celery_app):
        ...
        @celery_app.task(bind=True)
        def search_backend_analysis_task(self, 
                                       document_id: str,
                                       question_set_id: str,
                                       selected_questions: list,
                                       model_name: str = "gpt-4o-mini",
...
INTEGRATION_CONFIGS = {
    ...
    "lambda_deployment": {
        ...
        "memory": 1024,
        "environment": {
            "REPORT_ANALYST_CONFIG": "/opt/config.json"
        }
    },
