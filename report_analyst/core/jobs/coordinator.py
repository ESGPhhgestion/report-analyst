...
from .interfaces import (
    JobExecutor, JobDefinition, JobResult, JobStatus, 
    ExecutionBackend, JobHandler
)
...
class JobCoordinator:
    ...
    async def submit_job(self, 
                        job: JobDefinition, 
                        backend: Optional[ExecutionBackend] = None) -> str:
    ...
    async def list_jobs(self, 
                       ...
                       backend: Optional[ExecutionBackend] = None) -> List[JobResult]:
